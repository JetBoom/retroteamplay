...
function ENT:DrawTranslucent()
	...
	render.DrawSprite(pos, 48, 48, COLOR_YELLOW)
	...
	for i=1, 3 do
		...
		local particle = self.Emitter:Add("particle/smokestack", start)
		...
		particle = self.Emitter:Add("sprites/light_glow02_add", start)
		particle:SetDieTime(math.Rand(0.5, 0.75))
