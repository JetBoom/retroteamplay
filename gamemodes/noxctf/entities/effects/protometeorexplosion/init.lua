function EFFECT:Init(data)
	...
	sound.Play("nox/explosion0"..math.random(1,5)..".ogg", pos, 90, math.random(60, 70))
	...
	for i=1, 359, 7 do
		...
		particle:SetVelocity(Vector(1024 * sini, 1024 * cosi, math.random(1, 100)))
		...
		for x=0, 2 do
			...
			particle:SetVelocity(Vector(x * 640 * sini * math.Rand(0.9, 1.1), x * 640 * cosi * math.Rand(0.9, 1.1), 0))
	...
	ExplosiveEffect(pos, 200, 92, DMGTYPE_FIRE)
end
