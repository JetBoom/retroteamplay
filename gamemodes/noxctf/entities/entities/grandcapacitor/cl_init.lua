...
function ENT:TraceHUDPaint()
	if self.PHealth then
		...
		draw.SimpleText("Grand Capacitor", "teamplay", x, y, COLOR_CYAN, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("INDESTRUCTIBLE", "teamplaytargetidsmall", x, y, COLOR_CYAN, TEXT_ALIGN_CENTER)
