...
function ENT:DrawTranslucent()
	...
	render.DrawSprite(pos, 128, 128, Color(c.r, c.g, c.b))
	...
	for i=1, 3 do
		...
		local start = pos + heading * 6
		local vel = self:GetVelocity()

		local particle = self.Emitter:Add("effects/fire_embers"..math.random(1,3), start)
		...
		particle = self.Emitter:Add("particle/smokestack", start)
		particle:SetDieTime(math.Rand(0.5, 0.75))
		particle:SetStartAlpha(255)
