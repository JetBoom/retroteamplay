...
function ENT:DrawTranslucent()
	...
	local vOffset = Vector(32 * math.cos(self.Rotation), 32 * math.sin(self.Rotation), 32 * math.sin(self.Rotation))
	local pos1 = pos + vOffset
	render.DrawSprite(pos1, 32, 32, COLOR_ORANGE)
	render.DrawSprite(pos1, 32, 32, COLOR_RED)
	local pos2 = pos - vOffset
	render.DrawSprite(pos2, 32, 32, COLOR_ORANGE)
	render.DrawSprite(pos2, 32, 32, COLOR_RED)
