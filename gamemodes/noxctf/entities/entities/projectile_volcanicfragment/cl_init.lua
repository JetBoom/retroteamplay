...
function ENT:DrawOffScreen()
	...
	self.SmokeTimer = RealTime() + 0.1 * math.max(1, EFFECT_IQUALITY)
...
function ENT:DrawTranslucent()
	...
	if self:GetSkin() == 1 then
		...
		render.DrawSprite(vOffset, math.cos(realtime) * 100 + 150, math.sin(realtime) * 100 + 150, COLOR_CYAN)
		render.DrawSprite(vOffset, math.sin(realtime) * 100 + 150, math.cos(realtime) * 100 + 150, color_white)
