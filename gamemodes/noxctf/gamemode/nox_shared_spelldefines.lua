...
AddSpell("Greater Heal", "Heal yourself or one ally with a continuous stream of health.", 0, {"Wizard", "Conjurer", "Mage", "Templar"}, "ru un du", spells.GreaterHeal, "spellicons/greaterheal.png", true)
AddSpell("Haste", "Give yourself or an ally a speed boost for a short time.", 10, {"Wizard"}, "et cha cha", spells.Haste, "spellicons/haste.png", true, true)
...
AddSpell("Pixie Swarm", "Conjure a swarm of glowing pixies that surround you and attack all those who draw too close.", 20, {"Conjurer", "Templar"}, "et zo cha zo", spells.PixieSwarm, "spellicons/pixieswarm.png", nil, true)
...
AddSpell("Blink", "Teleport yourself instantly to a safe location.", 10, {"Wizard", "Conjurer", "Mage", "Templar", "Sorcerer", "Elementalist", "Necromancer", "Chronomancer"}, "cha et un", spells.Blink, "spellicons/blink.png")
...
AddSpell("Pull", "Pull all nearby things towards you.", 20, {"Wizard"}, "un un zo", spells.Pull, "spellicons/pull.png", nil, true)
AddSpell("Push", "Push all nearby things away from you.", 20, {"Wizard"}, "un un un", spells.Push, "spellicons/push.png", nil, true)
...
AddSpell("Force Field", "Reduce incoming damage by 25% until the field is destroyed.", 80, {"Wizard", "Mage", "Templar", "Spell Saber"}, "un et zo ka cha un et zo ka cha", spells.ForceField, "spellicons/forcefield.png", true, true)
...
AddSpell("Protect From Elements", "Reduce the damage taken from fire, shock and ice by 33% for a short time.", 50, {"Wizard", "Conjurer", "Mage", "Templar", "Sorcerer", "Elementalist"}, "du ka ru un et", spells.ProtectFromElements, "spellicons/protectfromshock.png", true, true)
AddSpell("Comet", "Call upon a giant ball of ice to crush your enemies.", 50, {"Mage", "Elementalist"}, "ru ka ru", spells.Comet, "spellicons/meteor.png", nil, true)
...
AddSpell("Astra", "Nullify the next hostile status you or an ally would take, or remove one immediately.", 30, {"Alchemist"}, "zo et zo et", spells.Astra, "spellicons/astra.png", true)
...
AddSpell("Rasp", "Conjure forth ethereal flames with potent mana dissipating properties.", 30, {"Alchemist"}, "ru zo et", spells.Rasp, "spellicons/rasp.png", nil, true)
AddSpell("Arcane Explosion", "Creates an explosion around the caster.", 35, {"Necromancer"}, "ru ru ka zo ka", spells.ArcaneExplosion, "spellicons/flamestrike.png", nil, true)
...
AddSpell("Blood Well", "Turns a nearby soul into a Blood Well which quickly heals allies.", 50, {"Necromancer"}, "zo ru in et et ru", spells.BloodWell, "spellicons/bloodwell.png", nil, true)
...
AddSpell("Ruin", "Corrode the material of your enemy's weapon, reducing its effectiveness.", 25, {"Alchemist"}, "cha zo cha", spells.Ruin, "spellicons/ruin.png", nil, true)
AddSpell("Aurify", "Turn an enemy to gold, slowing them and, if they do not escape, completely disabling them.", 0, {"Alchemist"}, "du et ru ka zo cha", spells.Aurify, "spellicons/aurify.png", nil, true)
AddSpell("Protometeor", "Call a gigantic infernal body from the sky to wreak catastrophic amounts of damage.", 60, {"Alchemist"}, "zo cha ka ru ru ru in du zo ru", spells.Protometeor, "spellicons/protometeor.png", nil, true)
