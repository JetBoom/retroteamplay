...
function ENT:GetTurretModel(turret)
	return "models/props_trainstation/TrackSign02.mdl"
end
...
function ENT:GetTurretPos(turret)
	return turret:GetPos() + turret:GetUp() * 32 + turret:GetForward() * -8
end

function ENT:GetTurretAngles(turret)
